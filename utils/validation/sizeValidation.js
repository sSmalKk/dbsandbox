...
const sizeDefault = require('../../constants/size');    
...
exports.schemaKeys = joi.object({
  ...
  Scale: joi.number().integer().allow(0),
  Verse: joi.string().default(sizeDefault.verse['medium']).allow(null).allow(''),
...
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      Scale: joi.alternatives().try(joi.array().items(),joi.number().integer(),joi.object()),
