/**
 * Universe_BigitemValidation.js
 * @description :: validate each post and put request as per Universe_Bigitem model
 */
...
/** validation keys and properties of Universe_Bigitem */
exports.schemaKeys = joi.object({
  ...
  structure: joi.string().regex(/^[0-9a-fA-F]{24}$/).allow(null).allow('')
}).unknown(true);

/** validation keys and properties of Universe_Bigitem for updation */
...
/** validation keys and properties of Universe_Bigitem for filter documents from collection */
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      structure: joi.alternatives().try(joi.array().items(),joi.string().regex(/^[0-9a-fA-F]{24}$/),joi.object()),
      id: joi.any(),
