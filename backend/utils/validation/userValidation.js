...
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      FriendList: joi.alternatives().try(joi.array().items(),joi.array().items(),joi.object()),
      Section: joi.alternatives().try(joi.array().items(),joi.array().items(),joi.object()),
