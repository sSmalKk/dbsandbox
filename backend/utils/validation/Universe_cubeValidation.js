...
exports.schemaKeys = joi.object({
  ...
  interface: joi.string().allow(null).allow(''),
  storage: joi.string().allow(null).allow('')
}).unknown(true);
...
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      interface: joi.alternatives().try(joi.array().items(),joi.string(),joi.object()),
      storage: joi.alternatives().try(joi.array().items(),joi.string(),joi.object()),
      id: joi.any(),
