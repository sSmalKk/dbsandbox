...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Joyce_Hilll',
      password: 'cZv5C3D8t4pW1iH',
      email: 'Zack92@hotmail.com',
      name: 'Lori Lemke',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 917,
      mobileNo: '(069) 494-4827',
      resetPasswordLink: {},
      loginRetryLimit: 412,
      loginReactiveTime: '2024-12-12T22:48:13.768Z',
      id: '66ec53c97e4ed7027c219b66'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jarod_Kuhlman',
        'password':'S0tB5EZPAKyhW9A',
        'email':'Jefferey_Pouros@yahoo.com',
        'name':'Devin Runolfsson',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Health',
          'address1':'enhance',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Jefferey_Pouros@yahoo.com', });
