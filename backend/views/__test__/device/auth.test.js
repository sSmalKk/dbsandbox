...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Camylle_Champlin',
      password: 'HCXUThxzIpXgvyT',
      email: 'Emie93@yahoo.com',
      name: 'Kurt Dibbert Sr.',
      shippingAddress: [
        {
          _id: false,
          pincode: 'port',
      ...
      userType: 63,
      mobileNo: '(908) 255-8828',
      resetPasswordLink: {},
      loginRetryLimit: 854,
      loginReactiveTime: '2025-06-16T21:38:16.035Z',
      id: '66ec53c97e4ed7027c219b21'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Gayle_OKon',
        'password':'CKxTbv_NwtWx2y7',
        'email':'Jermaine_Botsford@hotmail.com',
        'name':'Laurie Nolan',
        'shippingAddress':[{
          '_id':false,
          'pincode':'transmit',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'cross-platform'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(505) 787-8059',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Jermaine_Botsford@hotmail.com', });
