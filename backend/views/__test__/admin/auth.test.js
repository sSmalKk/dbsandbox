...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Erik80',
      password: '2y4NICswIJ8K3es',
      email: 'Myra.Beer93@gmail.com',
      name: 'Amanda Kiehn',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 884,
      mobileNo: '(776) 961-1350',
      resetPasswordLink: {},
      loginRetryLimit: 543,
      loginReactiveTime: '2025-06-12T10:21:28.245Z',
      id: '66ec53c97e4ed7027c219adc'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Margarita76',
        'password':'S1fhOsBHUf8uZOa',
        'email':'Milo.Doyle25@hotmail.com',
        'name':'Benny Murphy',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Investment',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'Optimization'
        }],
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(389) 735-9566',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Milo.Doyle25@hotmail.com', });
