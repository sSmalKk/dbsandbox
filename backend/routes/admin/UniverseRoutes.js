...
const UniverseCreate = require('../../middleware/UniverseCreate');
const checkRolePermission = require('../../middleware/checkRolePermission');

router.route('/admin/universe/create').post(auth(PLATFORM.ADMIN),UniverseCreate,checkRolePermission,UniverseController.addUniverse);
